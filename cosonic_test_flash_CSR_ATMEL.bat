...
call %atmel_path%\atbackend\atprogram -t atmelice -i PDI -d ATXMEGA32E5 -cl 7500khz chiperase


echo. 
echo MTCH6301:

call %atmel_path%\atbackend\atprogram -t atmelice -i PDI -d ATXMEGA32E5 -cl 7500khz program -ee --format hex -f "wear - MTCH_SET.eep"

call %atmel_path%\atbackend\atprogram -t atmelice -i PDI -d ATXMEGA32E5 -cl 7500khz program -fl --format hex -f "wear - MTCH_SET_3.elf"

if %ERRORLEVEL% == 0 (
	echo MTCH6301 PASS
) ELSE (
	echo MTCH6301 FAIL
	msg /time:5 "%username%" FAIL
	goto fail
)
...
call %atmel_path%\atbackend\atprogram -t atmelice -i PDI -d ATXMEGA32E5 -cl 7500khz program -fl --format hex -f "wear - nelson4.hex"
